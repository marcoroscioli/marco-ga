...
print("You've unlocked the ability: Fireball!")

player_spells_unlocked.append("Fireball")


print("Moving on, you start walking along the path. It starts raining, but there is a mansion in the distance. You take shelter there. But all of a sudden, the mansion starts flooding!!!")
print("The world starts swirling around you... You hear a gunshot! An almighty splash comes crashing down...")
print("YOU HAVE ENCOUNTERED THE MANKILLER WAVEMAN!!")

Wave_health = 130
while Wave_health > 0:
    print_player_health()
    print("Waveman Health: " + str(Wave_health))
    print_moves()
    choice = input("Enter your choice: ")
    if choice == '3':
        print("You use Vine whip on the Waveman!")
        Wave_health = Wave_health - 30
    if choice == '1':
        print("You use Staff Bonk on the Waveman!")
        Wave_health = Wave_health - 10
    if choice == '3':
        if current_player_mana < 15:
            print("You don't have enough mana!")
            continue
        print("You use Vine Whip on Waveman!")
        Wave_health = Wave_health - 30
        vine_whip += 1
        current_player_mana -= 15
    if choice == '2':
        ...
        exit()
    if vine_whip >= 1:
        print("The Waveman is stunned by the Vine Whip!")
        vine_whip -= 1
    else:
        Wave_attack()
    damage_player_tick()
    check_player_death()
print("You defeated the Waveman! He drops something. You pick it up and you recover ALL of your health!!!")
...
print("You've unlocked the ability: Hydraball!")

player_spells_unlocked.append("Hydraball")
